                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <div class="row clearfix">
                                @if (config('invoices.invoice_logo') != '')
                                    <div class="col-md-12 text-center">
                                        <img src="{{ config('invoices.invoice_logo') }}" style="width: 70px; height: 70px;"/>
                                    </div>
                                @endif

                                <div class="col-md-4 offset-4 text-center">
                                    <b>Invoice No : {{ $invoice->invoice_number }}</b>
                                    <br/>
                                    <b> Invoice Date : {{ $invoice->invoice_date }}</b>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix" style="margin-top:20px">
                                <div class="col-md-12">
                                  <span style="font-weight: bold">{{ config('invoices.invoice_footer') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
